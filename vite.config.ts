...
const types = readFileSync('svg.topoly.js.d.ts', 'utf8')
let emitted = false
...
const distExtras = {
  ...
  generateBundle() {
    ...
    this.emitFile({
      type: 'asset',
      fileName: 'svg.topoly.d.mts',
      source: types
    })
    this.emitFile({
      type: 'asset',
      fileName: 'svg.topoly.d.ts',
      source: types
    })
  }
}
