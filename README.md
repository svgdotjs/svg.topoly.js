...
<script src="https://cdn.jsdelivr.net/npm/@svgdotjs/svg.topoly.js/dist/svg.topoly.js"></script>
```

A bundle is also attached to every [release](https://github.com/svgdotjs/svg.topoly.js/releases).
